...
-- SQL matched with DatabaseConnection.java
...
-- =============================================================
-- TABLE: disaster_team_assignments
-- Feature 1: Team Coordination
-- =============================================================
...
-- =============================================================
-- SEED DATA
-- Same seed data style as DatabaseConnection.java
-- =============================================================

-- Default users
INSERT IGNORE INTO users (username, password_hash, role, full_name, email, department) VALUES
...
INSERT IGNORE INTO response_teams (team_name, department, team_leader, contact_number, status, capacity, current_members) VALUES
...
-- Sample resources
INSERT IGNORE INTO resources (resource_name, resource_type, quantity, unit, location, status, department) VALUES
